...
Generation date: 2026-07-27 09:05:05 +0200
...
const char *fsm_state_names[] = { "init", "idle", "error", "flash", "autonomous" };
...
transition_func_t *const fsm_transition_table[FSM_NUM_STATES][FSM_NUM_STATES] = {
    /* states:        init                  , idle                  , error                 , flash                 , autonomous             */
    /* init       */ { NULL, fsm_init_done, fsm_init_error, NULL, NULL },
    /* idle       */ { NULL, NULL, fsm_error_detected, fsm_start_flash, fsm_autonomous_enable },
    /* error      */ { NULL, NULL, NULL, NULL, NULL },
    /* flash      */ { NULL, fsm_flash_done, fsm_error_detected, NULL, NULL },
    /* autonomous */ { NULL, fsm_autonomous_disable, fsm_error_detected, NULL, NULL },
};
...
// valid return states: FSM_NO_CHANGE, FSM_STATE_IDLE, FSM_STATE_FLASH, FSM_STATE_ERROR, FSM_STATE_AUTONOMOUS
