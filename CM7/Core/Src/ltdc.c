...
void HAL_LTDC_MspInit(LTDC_HandleTypeDef *ltdcHandle) {
  ...
  */
    ...
    */
        ...
        GPIO_InitStruct.Pin = GPIO_PIN_10 | GPIO_PIN_2 | GPIO_PIN_4;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
        GPIO_InitStruct.Alternate = GPIO_AF14_LTDC;
...
void HAL_LTDC_MspDeInit(LTDC_HandleTypeDef *ltdcHandle) {
    ...
    */
        ...
        HAL_GPIO_DeInit(GPIOI, GPIO_PIN_9 | GPIO_PIN_10 | GPIO_PIN_11 | GPIO_PIN_15 | GPIO_PIN_2 | GPIO_PIN_4);

        HAL_GPIO_DeInit(GPIOF, GPIO_PIN_10);

        HAL_GPIO_DeInit(GPIOC, GPIO_PIN_0);

        HAL_GPIO_DeInit(GPIOH, GPIO_PIN_2 | GPIO_PIN_3 | GPIO_PIN_4 | GPIO_PIN_8 | GPIO_PIN_14);
