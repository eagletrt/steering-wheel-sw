...
EAGLETRT_STATIC const char *prv_parameter_names[INPUTS_SHARED_PARAMETER_ID_COUNT] = {
    ...
    [INPUTS_SHARED_PARAMETER_ID_TORQUE_VECTORING] = "TORQUE VECTORING",
    [INPUTS_SHARED_PARAMETER_ID_TRACTION_CONTROL] = "TRACTION CONTROL",
...
EAGLETRT_STATIC bool prv_popup_is_toggle(enum InputsSharedParameterID parameter_id) {
    return parameter_id == INPUTS_SHARED_PARAMETER_ID_TRACTION_CONTROL ||
